...
ALTER TABLE PROYECTOR_VIDEO DROP FOREIGN KEY FK_PROYECTOR_VIDEO_PROYECTOR_TV;
ALTER TABLE PROYECTOR_VIDEO DROP FOREIGN KEY FK_PROYECTOR_VIDEO_TARGETA_GRAFICA;
...
DROP TABLE IF EXISTS PROYECTOR_VIDEO;
...
CREATE TABLE DISPO_LECTORA(
    DISPO_LECTORA_ID    DECIMAL(3,0)    NOT NULL,
    ACTIVO_ID           DECIMAL(10, 0)  NOT NULL,
    UNIDAD_LECTORA_ID   DECIMAL(3,0)    NOT NULL,
...
CREATE TABLE DISPO_SO(
    DISPO_SO_ID             DECIMAL(3,0)    NOT NULL,
    ACTIVO_ID               DECIMAL(10, 0)  NOT NULL,
...
CREATE TABLE DISPO_VIDEO(
    DISPO_VIDEO_ID          DECIMAL(3,0)    NOT NULL,
    ACTIVO_ID               DECIMAL(10, 0)  NOT NULL,
...
-- _PROYECTOR_VIDEO
CREATE TABLE PROYECTOR_VIDEO(
    PROYECTOR_VIDEO_ID      DECIMAL(3,0)    NOT NULL,
    ACTIVO_ID               DECIMAL(10, 0)  NOT NULL,
    TARGETA_GARFICA_ID      DECIMAL(5,0)    NOT NULL,
    PRIMARY KEY (PROYECTOR_VIDEO_ID)
);
...
CREATE TABLE TARGETA_GRAFICA(
    ...
    TIPO_PCI_ID             DECIMAL(4,0)     NOT NULL,
...
CREATE TABLE TIPO_UNIDAD_LECTORA(
    TIPO_UNIDAD_LECTORA_ID               DECIMAL(3,0)    NOT NULL,
...
-- DE PROYECTOR_VIDEO
ALTER TABLE PROYECTOR_VIDEO ADD CONSTRAINT FK_PROYECTOR_VIDEO_PROYECTOR_TV
    FOREIGN KEY (ACTIVO_ID)
    REFERENCES PROYECTOR_TV(ACTIVO_ID);

ALTER TABLE PROYECTOR_VIDEO ADD CONSTRAINT FK_PROYECTOR_VIDEO_TARGETA_GRAFICA
    FOREIGN KEY (TARGETA_GARFICA_ID)
    REFERENCES TARGETA_GRAFICA(TARGETA_GARFICA_ID);
