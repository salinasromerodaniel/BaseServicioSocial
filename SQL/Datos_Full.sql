-- TIPO_PCI
SELECT * FROM TIPO_PCI WHERE TIPO_PCI_ID = 1 AND TIPO_PCI_NOMBRE = 'PCI';
SELECT * FROM TIPO_PCI WHERE TIPO_PCI_ID = 2 AND TIPO_PCI_NOMBRE = 'NAN';
SELECT * FROM TIPO_PCI WHERE TIPO_PCI_ID = 4 AND TIPO_PCI_NOMBRE = 'PCI EXPRESS';
SELECT * FROM TIPO_PCI WHERE TIPO_PCI_ID = 5 AND TIPO_PCI_NOMBRE = 'PCI-E 3.0';
SELECT * FROM TIPO_PCI WHERE TIPO_PCI_ID = 6 AND TIPO_PCI_NOMBRE = 'PCI-E 2.0 / ATI PCI-E 3.0';
SELECT * FROM TIPO_PCI WHERE TIPO_PCI_ID = 7 AND TIPO_PCI_NOMBRE = 'AGP/PCI';
SELECT * FROM TIPO_PCI WHERE TIPO_PCI_ID = 8 AND TIPO_PCI_NOMBRE = 'PCI 2.3';
SELECT * FROM TIPO_PCI WHERE TIPO_PCI_ID = 9 AND TIPO_PCI_NOMBRE = 'INTEGRADA';
...
-- TIPO_UNIDAD_LECTORA
INSERT INTO TIPO_UNIDAD_LECTORA VALUES (1, 'INTEGRADA'); 
INSERT INTO TIPO_UNIDAD_LECTORA VALUES (2, 'EXTERNA');
